  ...
  <Grid>
       ...
       <Grid item sx={{marginLeft:"59px"}}>
          ...
          />
            ...
            <Card
              raised
              sx={{ backgroundColor: "primary.light", padding: "20px",marginTop:"0px",height:"300px",marginBottom:"20px" }}
            >
              <Grid
                container
                direction="row"
            ...
            <Card
              raised
              sx={{ backgroundColor: "primary.light", padding: "20px",height:"250px",marginTop:"50px" }}
            >
